...
chromeProfilePath = r"C:\Users\Jimmy\AppData\Local\Google\Chrome\User Data\Profile 5"
...
keywords = ["data","analyst","support"]
#job experience Level - ex:  ["Internship", "Entry level" , "Associate" , "Mid-Senior level" , "Director" , "Executive"]
experienceLevels = [ "test" ]
